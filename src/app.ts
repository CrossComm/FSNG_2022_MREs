...
export default class MRETemplate {
	...
	private animation: MRE.Animation;
	...
	private async started() {
		...
		// const modelData = await this.assets.loadGltf('/assets/XBot_Test.gltf', "box");
		const modelData = await this.assets.loadGltf('microscope_slides.gltf', "box");
